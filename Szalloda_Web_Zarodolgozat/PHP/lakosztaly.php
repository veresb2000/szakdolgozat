...
<body>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="item active">
          <img src="../IMG/lakosztalySzoba1.jpg" alt="Los Angeles">
        </div>

        <div class="item">
          <img src="../IMG/lakosztalySzoba2.jpg" alt="Chicago">
        </div>

        <div class="item">
          <img src="../IMG/lakosztalySzoba3.jpg" alt="New York">
        </div>
      </div>
  ...
  <form action="lakosztalyFoglalas.php" method="POST">
    <div class="form">
      ...
      <div class="checkbox">
        <label><input type="checkbox" name="szoba[]" value="7">Csak reggeli, 2 férőhelyes, 15.000 Ft/éj</label>
      </div>
      <div class="checkbox">
        <label><input type="checkbox" name="szoba[]" value="8">Fél panzió, 4 férőhelyes, 17.500 Ft/éj</label>
      </div>
      <div class="checkbox">
        <label><input type="checkbox" name="szoba[]" value="9">Teljes ellátás, 6 férőhelyes, 22.000 Ft/éj</label>
      </div>
